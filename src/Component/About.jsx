...
function About() {
  return (
    <div id="About">
      ...
      <div className="grid items-center flex-wrap md:mb-20 mb-12 m-auto">
      ...
      <p className="md:w-[65%] p-4 text-[15px] mb-24 text-A-writeup text-center m-auto">Experienced and results-oriented Frontend Developer, having 2 years of experience. Offering a strong attention to details and accuracy, excellent problem-solving skills, and the important ability to work in fast-paced team environment. I am the reliable individual with a determination to meet and exceed all the assigned results </p>
    </div>
  )
}
